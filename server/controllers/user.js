...
exports.signUp = async (req, res, next) => {
    ...
    if (!checkErr.includes(1)){
        ...
        var url = "<a href='http://10.12.100.184::3001/users/confirm/"+vkey+"'>Confirm your email</a>";
...
exports.sendForget = async (req, res, next) => {
    ...
    if (!checkErr.includes(1)){
        ...
        var url = "<a href='http://10.12.100.184:3001/users/forget/"+vkey+"'>Change your password</a>";
